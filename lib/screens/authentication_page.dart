          ...
          child: Column(
            ...
            children: [
              ...
              FlatButton(
                ...
                child: Text('Şifremi unuttum', style: kSmallTextStyle.copyWith(color: Colors.blue, fontSize: 15)),
              ),
              Center(
                child: Container(
                  height: 45,
                  width: 160,
                  decoration:
                      BoxDecoration(gradient: functions.decideColor(context), borderRadius: BorderRadius.circular(20)),
                  child: FlatButton(
                    onPressed: () {
